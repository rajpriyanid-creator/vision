  ...
  return (
    <div className="w-full max-w-3xl mx-auto py-6">
      <div className="rounded-2xl bg-[#0E1526]/90 border border-[#1F2F4A] p-6 sm:p-8 shadow-2xl backdrop-blur-md relative overflow-hidden">
        ...
        {error && (
          <div className="mb-6 p-4 rounded-xl bg-rose-950/60 border border-rose-500/40 text-rose-300 text-xs font-mono flex items-start justify-between gap-2">
            <div className="flex items-center gap-2">
            ...
            <button
              onClick={clearError}
              className="text-[#8EA4B8] hover:text-white"
            >
